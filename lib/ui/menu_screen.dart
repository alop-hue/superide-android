  ...
  Widget build(BuildContext context) {
        ...
        .map((e) => Card(
              ...
              onTap: () => Navigator.of(context).push(PageRouteBuilder(
                  pageBuilder: (context, animation, secondaryAnimation) =>
                      EditorPage(
                          languageDetails: e, rootDir: '/sdcard/VSdroid/Temps'),
                  transitionsBuilder:
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) =>
          context.read<MenuSearchBloc>().add(Search(searchedLangs: const [])),
      child: BlocProvider(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                        onEditingComplete: () => context
                            .read<MenuSearchBloc>()
                            .add(Search(searchedLangs: const [])),
                        onChanged: (data) {
                          ...
                          List<Card> searchedLangs = searched
                              .map((e) => Card(
                                    ...
                                    onTap: () => Navigator.of(context).push(
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              EditorPage(languageDetails: e)),
                                    ),
                                  )))
                              .toList();
                          context.read<MenuSearchBloc>().add(Search(
                              searchedLangs:
                                  data.isEmpty ? [] : searchedLangs));
                        },
