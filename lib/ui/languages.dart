...
List<Language> languages = [
  ...
  Language(
    ...
    extension: 'go',
    details:
        'Known for simplicity and performance, ideal for concurrent programming.',
    language: go,
    helloWorld:
  ...
  Language(
    ...
    extension: 'dart',
    details:
        'Optimized for building fast, multi-platform apps, often with Flutter.',
    language: dart,
    helloWorld: 'void main() { print("Hello, World!"); }',
  ),
  Language(
    name: 'Json',
    extension: 'json',
