                ...
                return Column(
                  children: [
                    ...
                    projectTile(
                      ...
                      appThemestate.appTheme.selectScreenCardsBg,
                      () {
                    showDialog(
                      context: context,
                                    ...
                                    Navigator.of(context).push(
                                      PageRouteBuilder(
                                        pageBuilder: (context,animation,secondaryAnimation) =>
                                          FolderPage(dir:actualProjectDir),
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text("Project templates",
                          style: TextStyle(
                            color: appThemestate.appTheme.selectScreenCardTextColor,
                            fontSize: 20,
                            fontWeight: appThemestate.appTheme.isDark? FontWeight.w400 : FontWeight.w500,
                          ),
                        ),
                      ),
                    ),
                    ...
                    projectTile(
                      ...
                      SvgPicture.asset(
                          "assets/material_icons/folder-android.svg",
                          width: 30,
                          height: 30
                      ),
                      appThemestate.appTheme.selectScreenCardsBg,
                    ...
                    projectTile(
                      ...
                      "Create a react app",
                      SvgPicture.asset(
                          "assets/material_icons/folder-react-components.svg",
                          width: 30,
                          height: 30
                      ),
                      appThemestate.appTheme.selectScreenCardsBg,
