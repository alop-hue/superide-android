...
class _EditorPageState extends State<EditorPage> with TickerProviderStateMixin{
  ...
  late String codeFieldInitialText;
  ...
  void initState(){
    ...
    getData().then((initialText) {
      codeFieldInitialText = initialText;
      codeController = CodeController(
        language: widget.languageDetails.language,
        text: codeFieldInitialText,
      );
      setState(() {});
    });
    super.initState();
                                            ...
                                            trailing: InkWell(
                                              onTap: () async{
                                                if (findWordController.text.isNotEmpty) {
                                                  ...
                                                  await codeEditor.filePath.writeAsString(newData);
