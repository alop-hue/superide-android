  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final lspConfig = !widget.isProject ? snapshot.data!.length > 2 ? snapshot.data![2] as LspConfig? : null : null;
              ...
              builder: (context, editorState) {
                ...
                return PopScope(
                                        ...
                                        children: [
                                          ...
                                          DirectoryTreeViewerCustom(
                                            ...
                                            onFileTap: (f) async{
                                              ...
                                              final bloc = context.read<ActiveEditorBloc>();
                                              final key = '${lang.name}_${widget.rootDir}';
                                              LspConfig? lspConfig = bloc.sharedLspConfigs[key];
                                              if (lspConfig == null && uiBloc.state.codeForgeConfig['enableLSP']) {
                                                lspConfig = await startLspServer(
                                                ...
                                                bloc.sharedLspConfigs[key] = lspConfig;
                                              }
                                  ...
                                  FindWordWidget(
                                    ...
                                    onFileOpen: (file, lineNumber, searchQuery) async {
                                      ...
                                      if (existingIndex >= 0) {
                                        ...
                                        final bloc = context.read<ActiveEditorBloc>();
                                        final key = '${lang.name}_${widget.rootDir}';
                                        LspConfig? newLspConfig = bloc.sharedLspConfigs[key];
                                        if (newLspConfig == null && uiBloc.state.codeForgeConfig['enableLSP']) {
                                          ...
                                          bloc.sharedLspConfigs[key] = newLspConfig;
                                        }
                                        final newController = CodeForgeController(
                  ...
                  appBar: AppBar(
                    ...
                    bottom: editorState.activeEditors.isNotEmpty ? TabBar(
                  ...
                  body: editorState.activeEditors.isNotEmpty ? TabBarView(
                    controller: tabController,
