  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Settings", style: TextStyle(color: appTheme.selectScreenCardTextColor))
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            settingsTile(() {
              ...
              Icon(Icons.color_lens, size: 24, color: appTheme.selectScreenCardTextColor),
              appTheme.isDark,
            ),
            settingsTile((){
              showDialog(context: context, builder: (context)=>
            ...
            }, "Font Style", Icon(FontAwesomeIcons.font,color: appTheme.selectScreenCardTextColor, size: 21),appTheme.isDark),
          ],
        ),
      ),
    );
